...
set_property IOSTANDARD LVCMOS33 [get_ports move_backward]
...
set_property PACKAGE_PIN J2 [get_ports turn_left_light]
set_property IOSTANDARD LVCMOS33 [get_ports turn_left_light]

set_property PACKAGE_PIN K2 [get_ports turn_right_light]
...
set_property PACKAGE_PIN P2 [get_ports move_backward]
...
set_property PACKAGE_PIN K1 [get_ports {answer[3]}]
set_property PACKAGE_PIN H6 [get_ports {answer[2]}]
set_property PACKAGE_PIN H5 [get_ports {answer[1]}]
set_property PACKAGE_PIN J5 [get_ports {answer[0]}]
set_property PACKAGE_PIN F6 [get_ports {state[3]}]
set_property PACKAGE_PIN G4 [get_ports {state[2]}]
set_property PACKAGE_PIN G3 [get_ports {state[1]}]
set_property PACKAGE_PIN J4 [get_ports {state[0]}]
